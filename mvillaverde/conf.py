...
BLOG_AUTHOR = "Manuel Villaverde"  # (translatable)
BLOG_TITLE = "Manuel villaverde"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://villaverde.nom.es"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http/"
BLOG_EMAIL = "vialmajo@gmail.om"
BLOG_DESCRIPTION = "Web personal de Manuel Villaverde"  # (translatable)
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-1135254-4"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-1135254-4');
</script>
"""
